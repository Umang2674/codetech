  ...
  return (
    <div className='w-full relative h-screen overflow-hidden'>
      ...
      <div className='absolute w-full flex flex-col items-center mt-24'> 
        ...
        style={{
          textShadow: "2px 2px 0 #000,-2px -2px 0 #000,-2px -2px 0 #000,2px -2px 0 #000,-2px 2px 0 #000,2px 2px 0 #000,0px 2px 0 #000,0px -2px 0 #000,2px 0px 0 #000,-2px 0px 0 #000"
        }}
        >Coding Adventure</h2>
